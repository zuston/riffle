...
impl WriteOptions {
    pub fn with_write_all(data: BytesWrapper) -> Self {
        Self {
            append: false,
            data,
            offset: None,
    ...
    pub fn with_append_of_direct_io(data: BytesWrapper, offset: u64) -> Self {
        Self {
            append: true,
            data,
            offset: Some(offset),
    ...
    pub fn with_append_of_buffer_io(data: BytesWrapper) -> Self {
        Self {
            append: false,
            data,
            offset: None,
